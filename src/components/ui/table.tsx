...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        'hover:bg-muted data-[state=selected]:bg-muted border-b transition-colors last:[&>td]:last:rounded-br-lg last:[&>td]:first:rounded-bl-lg',
        className,
      )}
      {...props}
    />
...
const TableSkeletonRows = ({ rows = 1, columns = 1 }) => {
  return (
    <>
